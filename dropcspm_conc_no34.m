...
handles.dropcProg.output_filename='R8_spmc_acelo_no34';
% handles.dropcProg.output_file='C:\Users\Restrepo\Desktop\Justin\181101_R6_spm_1iso_MO.mat';
handles.dropcProg.output_path='C:\Users\Restrepo\Desktop\Justin\data\';
...
% handles.dropcProg.output_file='C:\Users\Restrepo\Desktop\Justin\190319_R9_spmconc_acehi_no34.mat';
...
%Which odor?
handles.dropcProg.odorName='acetophenone';

%Enter S+ valve (1,2,4,8,16,32,64,128) and odor name
handles.dropcProg.odorV(1)=uint8(1); %Make sure to use uint8
handles.dropcProg.odorPercent(1)=0.032;

handles.dropcProg.odorV(2)=uint8(8); %Make sure to use uint8
handles.dropcProg.odorPercent(2)=0.1;

%S- valves 
handles.dropcProg.odorV(3)=uint8(32); %Make sure to use uint8
handles.dropcProg.odorPercent(3)=3.2;

handles.dropcProg.odorV(4)=uint8(64); %Make sure to use uint8
handles.dropcProg.odorPercent(4)=10;
...
handles.dropcProg.randomSplus=ceil(10*rand(1,200)/5.3333);
handles.dropcProg.nSplus=0;

handles.dropcProg.randomSminus=ceil(10*rand(1,200)/5.3333)+2;
